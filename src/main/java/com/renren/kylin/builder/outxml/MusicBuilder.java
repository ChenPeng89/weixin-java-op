...
import com.renren.kylin.bean.message.WxOpXmlOutMusicMessage;
 ...
 * @author chanjarster
 */
public final class MusicBuilder extends BaseBuilder<MusicBuilder, WxOpXmlOutMusicMessage> {
  ...
  @Override
  public WxOpXmlOutMusicMessage build() {
    WxOpXmlOutMusicMessage m = new WxOpXmlOutMusicMessage();
    setCommon(m);
