...
public class WxOpMaterialNewsArticleGsonAdapter implements JsonSerializer<WxOpMaterialNews.WxOpMaterialNewsArticle>, JsonDeserializer<WxOpMaterialNews.WxOpMaterialNewsArticle> {

  @Override
  public JsonElement serialize(WxOpMaterialNews.WxOpMaterialNewsArticle article, Type typeOfSrc, JsonSerializationContext context) {
  ...
  @Override
  public WxOpMaterialNews.WxOpMaterialNewsArticle deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
    JsonObject articleInfo = jsonElement.getAsJsonObject();
    WxOpMaterialNews.WxOpMaterialNewsArticle article = new WxOpMaterialNews.WxOpMaterialNewsArticle();
