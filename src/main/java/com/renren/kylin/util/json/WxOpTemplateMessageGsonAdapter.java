...
import com.renren.kylin.bean.template.WxOpTemplateData;
import com.renren.kylin.bean.template.WxOpTemplateMessage;

import java.lang.reflect.Type;

public class WxOpTemplateMessageGsonAdapter implements JsonSerializer<WxOpTemplateMessage> {

  @Override
  public JsonElement serialize(WxOpTemplateMessage message, Type typeOfSrc, JsonSerializationContext context) {
    ...
    for (WxOpTemplateData datum : message.getData()) {
