 ...
 * @author Daniel Qian
 */
public class WxOpMassUploadResultAdapter implements JsonDeserializer<WxOpMassUploadResult> {

  @Override
  public WxOpMassUploadResult deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
    WxOpMassUploadResult uploadResult = new WxOpMassUploadResult();
