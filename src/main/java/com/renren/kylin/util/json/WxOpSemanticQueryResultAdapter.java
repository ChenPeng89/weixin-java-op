 ...
 * @author Daniel Qian
 */
public class WxOpSemanticQueryResultAdapter implements JsonDeserializer<WxOpSemanticQueryResult> {

  @Override
  public WxOpSemanticQueryResult deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
    WxOpSemanticQueryResult result = new WxOpSemanticQueryResult();
