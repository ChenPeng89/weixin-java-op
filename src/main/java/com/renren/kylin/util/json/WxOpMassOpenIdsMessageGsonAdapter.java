...
import com.renren.kylin.bean.WxOpMassOpenIdsMessage;
import me.chanjar.weixin.common.api.WxConsts;

import java.lang.reflect.Type;

public class WxOpMassOpenIdsMessageGsonAdapter implements JsonSerializer<WxOpMassOpenIdsMessage> {

  @Override
  public JsonElement serialize(WxOpMassOpenIdsMessage message, Type typeOfSrc, JsonSerializationContext context) {
