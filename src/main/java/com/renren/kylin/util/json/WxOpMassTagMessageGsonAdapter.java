...
import com.renren.kylin.bean.WxOpMassTagMessage;
import me.chanjar.weixin.common.api.WxConsts;

import java.lang.reflect.Type;

public class WxOpMassTagMessageGsonAdapter implements JsonSerializer<WxOpMassTagMessage> {

  @Override
  public JsonElement serialize(WxOpMassTagMessage message, Type typeOfSrc, JsonSerializationContext context) {
