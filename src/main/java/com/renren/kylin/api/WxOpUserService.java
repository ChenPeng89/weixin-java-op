 ...
 * @author Binary Wang
 */
public interface WxOpUserService {
   ...
   * @param remark 备注名
   */
  void userUpdateRemark(String openid, String remark, String appId) throws WxErrorException;
   ...
   * @param openid 用户openid
   */
  WxOpUser userInfo(String openid, String appId) throws WxErrorException;
   ...
   */
  WxOpUser userInfo(String openid, String lang, String appId) throws WxErrorException;
   ...
   */
  List<WxOpUser> userInfoList(List<String> openids, String appId) throws WxErrorException;
   ...
   */
  List<WxOpUser> userInfoList(WxOpUserQuery userQuery, String appId) throws WxErrorException;
   ...
   */
  WxOpUserList userList(String nextOpenid, String appId) throws WxErrorException;
}
