...
import com.renren.kylin.bean.template.WxOpTemplate;
 ...
 * </pre>
 */
public interface WxOpTemplateMsgService {
   ...
   * @return 是否成功
   */
  boolean setIndustry(WxOpTemplateIndustry wxOpIndustry) throws WxErrorException;
   ...
   * @return wxOpIndustry
   */
  WxOpTemplateIndustry getIndustry() throws WxErrorException;
   ...
   * @return 消息Id
   */
  String sendTemplateMsg(WxOpTemplateMessage templateMessage) throws WxErrorException;
   ...
   * @return templateId 模板Id
   */
  List<WxOpTemplate> getAllPrivateTemplate() throws WxErrorException;
