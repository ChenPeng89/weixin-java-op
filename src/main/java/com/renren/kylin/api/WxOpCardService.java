 ...
 */
public interface WxOpCardService {
   ...
   * @see #getCardApiTicket(boolean, String)
   */
  String getCardApiTicket(String appId) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  String getCardApiTicket(boolean forceRefresh, String appId) throws WxErrorException;
   ...
   * @return 卡券Api签名对象
   */
  WxCardApiSignature createCardApiSignature(String appId , String... optionalSignParam ) throws
          WxErrorException;
   ...
   * @return 解密后的Code
   */
  String decryptCardCode(String encryptCode, String appId) throws WxErrorException;
   ...
   * @return WxOpCardResult对象
   */
  WxOpCardResult queryCardCode(String cardId, String code, boolean checkConsume, String appId)
          throws WxErrorException;
   ...
   */
  String consumeCardCode(String code, String appId) throws WxErrorException;
   ...
   * <br>可用 com.google.gson.JsonParser#parse 等方法直接取JSON串中的errcode等信息。
   */
  String consumeCardCode(String code, String cardId, String appId) throws WxErrorException;
   ...
   */
  void markCardCode(String code, String cardId, String openId, boolean isMark, String appId) throws
          WxErrorException;
   ...
   */
  String getCardDetail(String cardId, String appId) throws WxErrorException;
}
