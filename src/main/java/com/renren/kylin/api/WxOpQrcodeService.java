 ...
 * @author Binary Wang
 */
public interface WxOpQrcodeService {
   ...
   */
  WxOpQrCodeTicket qrCodeCreateTmpTicket(int sceneId, Integer expireSeconds) throws WxErrorException;
   ...
   */
  WxOpQrCodeTicket qrCodeCreateLastTicket(int sceneId) throws WxErrorException;
   ...
   */
  WxOpQrCodeTicket qrCodeCreateLastTicket(String sceneStr) throws WxErrorException;
   ...
   */
  File qrCodePicture(WxOpQrCodeTicket ticket) throws WxErrorException;
