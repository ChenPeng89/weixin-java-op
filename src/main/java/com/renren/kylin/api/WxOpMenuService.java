...
import com.renren.kylin.bean.menu.WxOpGetSelfMenuInfoResult;
import com.renren.kylin.bean.menu.WxOpMenu;
 ...
 * @author Binary Wang
 */
public interface WxOpMenuService {
   ...
   * </pre>
   */
  WxOpMenu menuGet() throws WxErrorException;
   ...
   *</pre>
   */
  WxOpGetSelfMenuInfoResult getSelfMenuInfo() throws WxErrorException;
}
