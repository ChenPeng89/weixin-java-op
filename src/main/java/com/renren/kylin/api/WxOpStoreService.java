...
import com.renren.kylin.bean.store.WxOpStoreBaseInfo;
import com.renren.kylin.bean.store.WxOpStoreInfo;
import com.renren.kylin.bean.store.WxOpStoreListResult;
 ...
 */
public interface WxOpStoreService {
  /**
   * <pre>
   * 创建门店
   * 接口说明
   ...
   *
   */
  void add(WxOpStoreBaseInfo request) throws WxErrorException;
   ...
   */
  WxOpStoreBaseInfo get(String poiId) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  WxOpStoreListResult list(int begin, int limit) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  List<WxOpStoreInfo> listAll() throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  void update(WxOpStoreBaseInfo info) throws WxErrorException;
