 ...
 * </pre>
 */
public interface WxOpMaterialService {
   ...
   * @see #mediaUpload(String, String, InputStream , String)
   */
  WxMediaUploadResult mediaUpload(String mediaType, File file, String appId) throws WxErrorException;
   ...
   * @throws WxErrorException
   * @see #mediaUpload(String, File, String)
   */
  WxMediaUploadResult mediaUpload(String mediaType, String fileType, InputStream inputStream, String appId) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  File mediaDownload(String media_id, String appId) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  WxMediaImgUploadResult mediaImgUpload(File file, String appId) throws WxErrorException;
   ...
   *
   * @param mediaType 媒体类型, 请看{@link me.chanjar.weixin.common.api.WxConsts}
   * @param material  上传的素材, 请看{@link WxOpMaterial}
   */
  WxOpMaterialUploadResult materialFileUpload(String mediaType, WxOpMaterial material, String appId) throws WxErrorException;
   ...
   * </pre>
   *
   * @param news 上传的图文消息, 请看{@link WxOpMaterialNews}
   */
  WxOpMaterialUploadResult materialNewsUpload(WxOpMaterialNews news, String appId) throws WxErrorException;
   ...
   */
  InputStream materialImageOrVoiceDownload(String mediaId, String appId) throws WxErrorException;
   ...
   * @param mediaId 永久素材的id
   */
  WxOpMaterialVideoInfoResult materialVideoInfo(String mediaId, String appId) throws WxErrorException;
   ...
   * @param mediaId 永久素材的id
   */
  WxOpMaterialNews materialNewsInfo(String mediaId, String appId) throws WxErrorException;
   ...
   * </pre>
   *
   * @param wxOpMaterialArticleUpdate 用来更新图文素材的bean, 请看{@link WxOpMaterialArticleUpdate}
   */
  boolean materialNewsUpdate(WxOpMaterialArticleUpdate wxOpMaterialArticleUpdate, String appId) throws WxErrorException;
   ...
   * @param mediaId 永久素材的id
   */
  boolean materialDelete(String mediaId, String appId) throws WxErrorException;
   ...
   * </pre>
   */
  WxOpMaterialCountResult materialCount(String appId) throws WxErrorException;
   ...
   */
  WxOpMaterialNewsBatchGetResult materialNewsBatchGet(int offset, int count, String appId) throws WxErrorException;
   ...
   * @param count  返回素材的数量，取值在1到20之间
   */
  WxOpMaterialFileBatchGetResult materialFileBatchGet(String type, int offset, int count, String appId) throws WxErrorException;
