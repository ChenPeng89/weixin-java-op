 ...
 * </pre>
 */
public class WxOpTemplate {

  private static final JsonParser JSON_PARSER = new JsonParser();

  public static List< WxOpTemplate> fromJson(String json) {
    return WxOpGsonBuilder.create().fromJson(JSON_PARSER.parse(json).getAsJsonObject().get("template_list"),
        new TypeToken<List< WxOpTemplate>>() {
        }.getType());
  }
