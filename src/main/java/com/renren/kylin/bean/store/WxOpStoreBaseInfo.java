 ...
 */
public class WxOpStoreBaseInfo {
  @Override
  public String toString() {
    return ToStringUtils.toSimpleString(this);
  }

  public static WxOpStoreBaseInfo fromJson(String json) {
    return WxOpGsonBuilder.create().fromJson(json, WxOpStoreBaseInfo.class);
  }

  public String toJson() {
    JsonElement base_info = WxOpGsonBuilder.create().toJsonTree(this);
  ...
  public static class WxOpStorePhoto {
    /**
     * 照片url
     */
  ...
  */
  ...
  private List<WxOpStorePhoto> photos;
  ...
  */
  ...
  public List<WxOpStorePhoto> getPhotos() {
    return this.photos;
  }

  public void setPhotos(List<WxOpStorePhoto> photos) {
    this.photos = photos;
  }
  ...
  public static WxOpStoreBaseInfoBuilder builder() {
    return new WxOpStoreBaseInfoBuilder();
  }

  public static class WxOpStoreBaseInfoBuilder {
    private String sid;
    private String businessName;
    private String branchName;
    private String province;
    ...
    public WxOpStoreBaseInfoBuilder sid(String sid) {
      this.sid = sid;
      return this;
    }

    public WxOpStoreBaseInfoBuilder businessName(String businessName) {
      this.businessName = businessName;
      return this;
    }

    public WxOpStoreBaseInfoBuilder branchName(String branchName) {
      this.branchName = branchName;
      return this;
    }

    public WxOpStoreBaseInfoBuilder province(String province) {
      this.province = province;
      return this;
    }

    public WxOpStoreBaseInfoBuilder city(String city) {
      this.city = city;
      return this;
    }

    public WxOpStoreBaseInfoBuilder district(String district) {
      this.district = district;
      return this;
    }

    public WxOpStoreBaseInfoBuilder address(String address) {
      this.address = address;
      return this;
    }

    public WxOpStoreBaseInfoBuilder telephone(String telephone) {
      this.telephone = telephone;
      return this;
    }

    public WxOpStoreBaseInfoBuilder categories(String[] categories) {
      this.categories = categories;
      return this;
    }

    public WxOpStoreBaseInfoBuilder offsetType(Integer offsetType) {
      this.offsetType = offsetType;
      return this;
    }

    public WxOpStoreBaseInfoBuilder longitude(BigDecimal longitude) {
      this.longitude = longitude;
      return this;
    }

    public WxOpStoreBaseInfoBuilder latitude(BigDecimal latitude) {
      this.latitude = latitude;
      return this;
    }

    public WxOpStoreBaseInfoBuilder photos(List<WxOpStorePhoto> photos) {
      this.photos = photos;
      return this;
    }

    public WxOpStoreBaseInfoBuilder recommend(String recommend) {
      this.recommend = recommend;
      return this;
    }

    public WxOpStoreBaseInfoBuilder special(String special) {
      this.special = special;
      return this;
    }

    public WxOpStoreBaseInfoBuilder introduction(String introduction) {
      this.introduction = introduction;
      return this;
    }

    public WxOpStoreBaseInfoBuilder openTime(String openTime) {
      this.openTime = openTime;
      return this;
    }

    public WxOpStoreBaseInfoBuilder avgPrice(Integer avgPrice) {
      this.avgPrice = avgPrice;
      return this;
    }

    public WxOpStoreBaseInfoBuilder availableState(Integer availableState) {
      this.availableState = availableState;
      return this;
    }

    public WxOpStoreBaseInfoBuilder updateStatus(Integer updateStatus) {
      this.updateStatus = updateStatus;
      return this;
    }

    public WxOpStoreBaseInfoBuilder poiId(String poiId) {
      this.poiId = poiId;
      return this;
    }

    public WxOpStoreBaseInfoBuilder from(WxOpStoreBaseInfo origin) {
      this.sid(origin.sid);
    ...
    public WxOpStoreBaseInfo build() {
      WxOpStoreBaseInfo m = new WxOpStoreBaseInfo();
      m.sid = this.sid;
