 ...
 */
@XStreamAlias("xml")
public class WxOpXmlMessage implements Serializable {
  ...
  private Integer deviceStatus;
    ...
    private int authorizationCodeExpiredTime;



  public static WxOpXmlMessage fromXml(String xml) {
    return XStreamTransformer.fromXml(WxOpXmlMessage.class, xml);
  }

  public static WxOpXmlMessage fromXml(InputStream is) {
    return XStreamTransformer.fromXml(WxOpXmlMessage.class, is);
  }
   ...
   *
   * @param encryptedXml
   * @param wxOpConfigStorage
   * @param timestamp
   * @param nonce
   * @param msgSignature
   */
  public static WxOpXmlMessage fromEncryptedXml(String encryptedXml,
                                                WxOpConfigStorage wxOpConfigStorage, String timestamp, String nonce,
                                                String msgSignature) {
    WxOpCryptUtil cryptUtil = new WxOpCryptUtil(wxOpConfigStorage);
    String plainText = cryptUtil.decrypt(msgSignature, timestamp, nonce,
      encryptedXml);
    return fromXml(plainText);
  }

  public static WxOpXmlMessage fromEncryptedXml(InputStream is,
                                                WxOpConfigStorage wxOpConfigStorage, String timestamp, String nonce,
                                                String msgSignature) {
    try {
      return fromEncryptedXml(IOUtils.toString(is, "UTF-8"), wxOpConfigStorage,
  ...
  public WxOpXmlMessage.ScanCodeInfo getScanCodeInfo() {
    return this.scanCodeInfo;
  }

  public void setScanCodeInfo(WxOpXmlMessage.ScanCodeInfo scanCodeInfo) {
    this.scanCodeInfo = scanCodeInfo;
  }

  public WxOpXmlMessage.SendPicsInfo getSendPicsInfo() {
    return this.sendPicsInfo;
  }

  public void setSendPicsInfo(WxOpXmlMessage.SendPicsInfo sendPicsInfo) {
    this.sendPicsInfo = sendPicsInfo;
  }

  public WxOpXmlMessage.SendLocationInfo getSendLocationInfo() {
    return this.sendLocationInfo;
  }

  public void setSendLocationInfo(
    WxOpXmlMessage.SendLocationInfo sendLocationInfo) {
