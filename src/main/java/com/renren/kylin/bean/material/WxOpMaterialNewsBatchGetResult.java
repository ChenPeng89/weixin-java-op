...
public class WxOpMaterialNewsBatchGetResult implements Serializable {
  ...
  public static class WxMaterialNewsBatchGetNewsItem {
    ...
    private WxOpMaterialNews content;
    ...
    public WxOpMaterialNews getContent() {
      return this.content;
    }

    public void setContent(WxOpMaterialNews content) {
