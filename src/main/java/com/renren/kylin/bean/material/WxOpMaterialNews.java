...
public class WxOpMaterialNews implements Serializable {
  private static final long serialVersionUID = -3283203652013494976L;

  private List<WxOpMaterialNewsArticle> articles = new ArrayList<>();

  public List<WxOpMaterialNewsArticle> getArticles() {
    return this.articles;
  }

  public void addArticle(WxOpMaterialNewsArticle article) {
   ...
   * @author chanjarster
   */
  public static class WxOpMaterialNewsArticle {
    /**
