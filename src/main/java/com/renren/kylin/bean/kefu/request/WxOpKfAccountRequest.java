package com.renren.kylin.bean.kefu.request;
...
public class WxOpKfAccountRequest implements Serializable {
  ...
  public static class Builder {
      ...
      public Builder from(WxOpKfAccountRequest origin) {
      ...
      public WxOpKfAccountRequest build() {
          WxOpKfAccountRequest m = new WxOpKfAccountRequest();
