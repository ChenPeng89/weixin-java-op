package com.renren.kylin.bean.kefu;

import com.renren.kylin.builder.kefu.OpNewsBuilder;
import com.renren.kylin.builder.kefu.WxCardBuilder;
 ...
 * @author chanjarster
 */
public class WxOpKefuMessage implements Serializable {
   ...
   */
  public static OpNewsBuilder MPNEWS() {
    return new OpNewsBuilder();
  }
  ...
  public String getOpNewsMediaId() {
    return this.mpNewsMediaId;
  }

  public void setOpNewsMediaId(String mpNewsMediaId) {
