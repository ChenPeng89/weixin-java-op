 ...
 * @author chanjarster
 */
public class WxOpMassNews implements Serializable {

  /**
   *
   */
  private static final long serialVersionUID = 565937155013581016L;
  private List<WxOpMassNewsArticle> articles = new ArrayList<>();

  public List<WxOpMassNewsArticle> getArticles() {
    return this.articles;
  }

  public void addArticle(WxOpMassNewsArticle article) {
   ...
   * @author chanjarster
   */
  public static class WxOpMassNewsArticle {
    /**
